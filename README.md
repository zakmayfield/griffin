...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create griffin-d15c
  fly apps create griffin-d15c-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app griffin-d15c
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app griffin-d15c-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'griffin-d15c-staging' does not match app name in config file 'griffin-d15c'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name griffin-d15c-db
  fly postgres attach --app griffin-d15c griffin-d15c-db

  fly postgres create --name griffin-d15c-staging-db
  fly postgres attach --app griffin-d15c-staging griffin-d15c-staging-db
  ```
